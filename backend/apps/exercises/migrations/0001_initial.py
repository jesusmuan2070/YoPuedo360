    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grammar_topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_exercises', to='grammar.grammartopic')),
                ('milestone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_exercises', to='scenarios.milestone')),
            ],
            options={
