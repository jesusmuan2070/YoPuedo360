# Generated by Django 5.2.7 on 2026-01-14 17:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('content', '0002_grammartopic_grammarlesson_milestonegrammar_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grammar_topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_exercises', to='content.grammartopic')),
                ('milestone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_exercises', to='memory_palace.milestone')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user', 'exercise_type', 'exercise_id'], name='exercises_e_user_id_58e538_idx'), models.Index(fields=['user', 'completed_at'], name='exercises_e_user_id_bf6e34_idx')],
            },
        ),
    ]
